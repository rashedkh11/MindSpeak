                            ...
                            <?php foreach ($appointments as $appt) { ?>
                                <tr>
									...
									<h2 class="table-avatar">
										<a href="doctor-profile.php?doctor_id=<?= $appt['doctor_id'] ?>" class="avatar avatar-sm mr-2">
											<img alt="Image placeholder" src="<?=htmlspecialchars($appt['doctor_image']) ?>" class="avatar rounded-circle">
										</a>
										<a href="doctor-profile.php?doctor_id=<?= $appt['doctor_id'] ?>">
																...
																<?php if (count($appointments2) > 0) { ?>
																	<?php foreach ($appointments2 as $appt2) { ?>
																		<tr>
																			<td>
																			<h2 class="table-avatar">
																				<a href="doctor-profile.php?doctor_id=<?= $appt2['doctor_id'] ?>" class="avatar avatar-sm mr-2">
																					<img alt="Image placeholder" src="<?=htmlspecialchars($appt2['doctor_image']) ?>" class="avatar rounded-circle">
																				</a>
																				<a href="doctor-profile.php?doctor_id=<?= $appt2['doctor_id'] ?>">
