...
<head>
    ...
    <title>MindSpeak - AI-Powered Mental Health Support</title>
    ...
    <style>
        ...
        /* CTA Section */
        .cta-section {
            background: linear-gradient(135deg, #5D5FEF, #6B46C1);
            color: white;
            padding: 60px 0;
            border-radius: 10px;
        }
        ...
        .col-md-12.mb-4 {
    margin-bottom: 1.5rem !important; /* Was default ~2.5rem */
}
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <div class="d-flex gap-3 justify-content-center">
                            ...
                            <?php else: ?>
                                ...
                                <a href="appointments.php" class="btn btn-outline-light btn-lg px-4">Book Session</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-center text-lg-end" data-aos="fade-left" data-aos-delay="200">
                <a href="<?= isset($_SESSION['user_id']) ? 'patient-dashboard.php' : 'register.php' ?>" 
                   class="cta-btn">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="blogdetails.php?id=<?= $post['id'] ?>" class="read-more">
